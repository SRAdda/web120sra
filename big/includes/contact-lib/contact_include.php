...
{//siteKeys not provided - exit
    echo '<p>Please go into the config.php file and place the  
    siteKey and secretKey for the domain where your forms 
    will be posted.</p>';
    die;
}
...
function dateFeedback($feedbackWanted)
{
	...
	{
		$feedback = "<div class=\"dateFeedback\">Please verify you are not a robot - ";
