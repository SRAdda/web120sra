...
#EDIT THE FOLLOWING:
$toAddress = "sallyrossdesign@gmail.com";  //place your/your client's email address here
$toName = "Sally Ross"; //place your client's name here
$website = "Sally Ross's Website";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
<!-- START HTML FORM -->
	...
	<div>	
		<fieldset>
			...
			<input type="checkbox" name="Interested_In[]" value="Lollipops" /> Complimentary Consultation <br />
